...
Now, we convert data frame to survey object. Allows for calculating summary statistics without re-specifying the weight each time.
...
```
We see that we were able to successfully reproduce the estimates. However, the standard errors are slightly off. 
