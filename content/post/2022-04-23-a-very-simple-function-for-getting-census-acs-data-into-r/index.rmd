...
```
Note that the estimate value is being stored as a character variable. The Census uses character codes like "*" to indicate missing or topcoded valued. As is often the case, it is necessary to perform additional cleaning after retrieving the data.